...
public class ApiResponse<T> implements Serializable {
	 ...
	 */
	ApiResponse(int code, String message, T result) {
		super();
	 ...
	 * @return the wrapper
	 */
	private ApiResponse<T> code(int code) {
		this.setCode(code);
		return this;
	}
	 ...
	 * @return the wrapper
	 */
	private ApiResponse<T> message(String message) {
	...
	public boolean success() {
		return ApiResponse.SUCCESS_CODE == this.code;
	}
