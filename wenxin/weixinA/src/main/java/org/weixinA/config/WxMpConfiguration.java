...
import org.weixinA.handler.ImageHandler;
import org.weixinA.handler.KfSessionHandler;
import org.weixinA.handler.LocationHandler;
import org.weixinA.handler.LogHandler;
import org.weixinA.handler.MenuHandler;
import org.weixinA.handler.MsgHandler;
import org.weixinA.handler.NullHandler;
import org.weixinA.handler.ScanHandler;
import org.weixinA.handler.SubscribeHandler;
import org.weixinA.handler.UnsubscribeHandler;
...
public class WxMpConfiguration {
	...
	public WxMpMessageRouter messageRouter(WxMpService wxMpService) {
		...
		// 接受图片
		newRouter.rule().async(false).msgType(XmlMsgType.IMAGE).handler(this.imageHandler)
				.end();
