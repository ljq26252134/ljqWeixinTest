...
public class WxMenuController {
	...
	public String menuCreateSample(@PathVariable String appid) throws WxErrorException, MalformedURLException {
		...
		button1.setName("点击获取二维码");
		button1.setKey("QRCODE");

		WxMenuButton button3 = new WxMenuButton();
		button3.setName("菜单");
		WxMenuButton button2 = new WxMenuButton();
		button2.setType(MenuButtonType.PIC_PHOTO_OR_ALBUM);
		button2.setName("图片");
		button2.setKey("ljqTest");
		...
		if (servletRequestAttributes != null) {
			...
			String url = this.wxService.switchoverTo(appid).oauth2buildAuthorizationUrl(String
					.format("%s://%s/weixinA/wx/redirect/%s/greet", requestURL.getProtocol(), WeixinAConstants.extraUrl, appid),
